...
window.importkey = function () {
	if (key = prompt("Insert key here3")) {

		console.log(key);

		var privkey = require('buffer/').Buffer('5ff7e0afdcb144a5e625f282fc28fbae675906c3f3645051baab0dc3d69ef5e4', 'hex');
		console.log(privkey);
		var Wallet = require('ethereumjs-wallet');
		var wallet = Wallet.fromPrivateKey(privkey);


		var pubkey = wallet.getChecksumAddressString();
		console.log(pubkey);
